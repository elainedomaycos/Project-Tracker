...
//#endregion
//#region node_modules/groq-sdk/core/error.mjs
var GroqError = class extends Error {};
var APIError = class APIError extends GroqError {
...
//#endregion
//#region node_modules/groq-sdk/internal/utils/values.mjs
...
var validatePositiveInteger = (name, n) => {
	if (typeof n !== "number" || !Number.isInteger(n)) throw new GroqError(`${name} must be an integer`);
	if (n < 0) throw new GroqError(`${name} must be a positive integer`);
	return n;
};
var safeJSON = (text) => {
	try {
...
//#endregion
//#region node_modules/groq-sdk/internal/utils/sleep.mjs
var sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
//#endregion
//#region node_modules/groq-sdk/version.mjs
var VERSION = "1.3.0";
//#endregion
//#region node_modules/groq-sdk/internal/detect-platform.mjs
...
//#endregion
//#region node_modules/groq-sdk/internal/to-file.mjs
/**
...
//#endregion
//#region node_modules/groq-sdk/internal/headers.mjs
...
//#endregion
//#region node_modules/groq-sdk/resources/audio/speech.mjs
...
//#endregion
//#region node_modules/groq-sdk/resources/audio/transcriptions.mjs
var Transcriptions = class extends APIResource {
	...
	*/
	create(body, options) {
		return this._client.post("/openai/v1/audio/transcriptions", multipartFormRequestOptions({
			body,
			...options
		}, this._client));
	}
...
//#endregion
//#region node_modules/groq-sdk/resources/audio/translations.mjs
var Translations = class extends APIResource {
	...
	*/
	create(body, options) {
		return this._client.post("/openai/v1/audio/translations", multipartFormRequestOptions({
			body,
			...options
		}, this._client));
	}
...
//#endregion
//#region node_modules/groq-sdk/resources/audio/audio.mjs
...
//#endregion
//#region node_modules/groq-sdk/resources/batches.mjs
...
//#endregion
//#region node_modules/groq-sdk/resources/chat/completions.mjs
...
//#endregion
//#region node_modules/groq-sdk/resources/chat/chat.mjs
...
//#endregion
//#region node_modules/groq-sdk/resources/embeddings.mjs
...
//#endregion
//#region node_modules/groq-sdk/resources/files.mjs
var Files = class extends APIResource {
	...
	*/
	create(body, options) {
		return this._client.post("/openai/v1/files", multipartFormRequestOptions({
			body,
			...options
		}, this._client));
	}
...
//#endregion
//#region node_modules/groq-sdk/resources/models.mjs
...
//#endregion
//#region node_modules/groq-sdk/core/streaming.mjs
var _Stream_client;
var Stream = class Stream {
	...
	static fromSSEResponse(response, controller, client) {
		...
		async function* iterator() {
			if (consumed) throw new GroqError("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");
			consumed = true;
			let done = false;
			try {
...
async function* _iterSSEMessages(response, controller) {
	if (!response.body) {
		controller.abort();
		if (typeof globalThis.navigator !== "undefined" && globalThis.navigator.product === "ReactNative") throw new GroqError(`The default react-native fetch implementation does not support streaming. Please use expo/fetch: https://docs.expo.dev/versions/latest/sdk/expo/#expofetch-api`);
...
async function defaultParseResponse(client, props) {
	...
	const body = await (async () => {
		...
		if (props.options.stream) return Stream.fromSSEResponse(response, props.controller, client);
...
//#endregion
//#region node_modules/groq-sdk/client.mjs
var _Groq_instances;
var _a;
var _Groq_encoder;
...
var Groq = class {
	...
	*/
	constructor({ baseURL = readEnv("GROQ_BASE_URL"), apiKey = readEnv("GROQ_API_KEY"), ...opts } = {}) {
		...
		if (apiKey === void 0) throw new GroqError("The GROQ_API_KEY environment variable is missing or empty; either provide it, or instantiate the Groq client with an apiKey option, like new Groq({ apiKey: 'My API Key' }).");
		const options = {
			apiKey,
			...opts,
			baseURL: baseURL || `https://api.groq.com`
		};
		if (!options.dangerouslyAllowBrowser && isRunningInBrowser()) throw new GroqError("It looks like you're running in a browser-like environment.\n\nThis is disabled by default, as it risks exposing your secret API credentials to attackers.\nIf you understand the risks and have appropriate mitigations in place,\nyou can set the `dangerouslyAllowBrowser` option to `true`, e.g.,\n\nnew Groq({ apiKey, dangerouslyAllowBrowser: true })");
	...
	*/
	...
	buildBody({ options }) {
		...
		if (!body) {
			if (body == null && "body" in options) return __classPrivateFieldGet(this, _Groq_encoder, "f").call(this, {
				body,
		...
		else return __classPrivateFieldGet(this, _Groq_encoder, "f").call(this, {
			body,
			headers
		});
	}
};
_a = Groq, _Groq_encoder = /* @__PURE__ */ new WeakMap(), _Groq_instances = /* @__PURE__ */ new WeakSet(), _Groq_baseURLOverridden = function _Groq_baseURLOverridden() {
